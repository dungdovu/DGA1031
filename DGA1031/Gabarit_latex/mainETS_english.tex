...
\title{An advance algorithm WIT for a new virtual assistance}
...
\directeur{Prof. }{Sylvie Ratté}{Software and Information Technologies
	
}

%\directeur{Mrs.}{Prénom Nom}{Nom du département et institution}

\codirecteur{Dr.}{Ronald Brisebois}{Bibliomondo }
