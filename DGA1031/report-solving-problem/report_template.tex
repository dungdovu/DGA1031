...
\title{MedicBot: A New Virtual Assistance For The
	Auditory Processing Disorder People}
...
How to identify, recognize, and
diagnosing students with
Auditory Processing Disorder
(APD) based on their
sentiment behavior, speech,
and response.
\par How to help users to solve
their issues above and
comment the therapy to them
by training.
